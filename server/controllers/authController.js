...
const register = async (req, res) => {
  ...
  res.status(StatusCodes.CREATED).json({msg: "success. Check email."})
}
...
const login = async (req, res) => {
  ...
  if (!user.isVerified) {
    throw new CustomError.UnauthenticatedError("Verify your email")
  }
...
const forgotPassword = async (req, res) => {
  ...
  if (!email) {
    throw new CustomError.BadRequestError("No email found")
  }
  ...
  res.status(StatusCodes.OK).json({msg: "Please check email for password reset link"})
}
